...
// createEntity(), in array order — World has no "create with this id" escape hatch and doesn't
// need one), then hydrate each entity's persisted components, remapping any saved index back to
// the newly-created entity id it now corresponds to.
